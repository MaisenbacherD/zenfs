...
for VALUE_SIZE in 100 200 400 1000 2000 8000; do
  ...
  DB_BENCH_PARAMS="--benchmarks=readwhilewriting --use_existing_db --num=$NUM --value_size=$VALUE_SIZE --compression_type=none --histogram $FS_PARAMS $DB_BENCH_EXTRA_PARAMS"
